...
![Cancer stage](../results/04_plot_0.png){width=50%}


## Visualizing our data (2/10)  
...
![size vs stage](../results/04_plot_1.png){width=50%}

## Visualizing our data (3/10)  
...
![Reason of death](../results/04_plot_2.png){width=50%}
...
![acid phosphatase and SG index](../results/04_plot_3.png){width=50%}

## Visualizing our data (5/10)
...
![Treatment vs survival](../results/04_plot_3.5.png){width=50%}

## Visualizing our data (6/10)   -> need bullet points (Maria)
![Testing image](../results/04_plot_4.png){width=50%}

## Visualizing our data (7/10)   -> need bullet points (Maria)
![Testing image](../results/04_plot_5.png){width=50%}

## Visualizing our data (8/10) 
- There is 16% of patients in stage 4 with bone metastases
![Bone metastases](../results/04_plot_6.png){width=50%}

## Visualizing our data (9/10)  
...
![estimates](../results/05_plot_estimate.png){width=50%}

## Visualizing our data (10/10)   
- The manhattan plot corroborates the previous slides observations

![Manhattan plot](../results/05_plot_manhattan.png){width=50%}
...
![k-means clustering](../results/06_plot_kmean.png){width=50%}
